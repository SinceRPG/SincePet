...
<div class="cards">
  ...
  <a class="card" href="gui.html"><strong>Customize GUI</strong><span>Every item meta field, upgrade item states, placeholders, and per-upgrade overrides.</span></a>
...
| [GUI Configuration](gui.md) | Item meta, upgrade templates, placeholders, and per-upgrade overrides. |
